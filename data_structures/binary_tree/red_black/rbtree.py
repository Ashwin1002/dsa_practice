        ...
        while new_node != self.root and new_node.parent.red:
            ...
            if parent == grandparent.right:
                ...
                if uncle.red:
                    ...
                    parent.red = False
                    uncle.red = False
                    new_node = grandparent  # Move up the tree
                else:
                    # Uncle is black (rotation case)
                    if new_node == parent.left:
                        # If the new node is a left child, perform a right rotation
                        new_node = parent
            ...
            # Parent is the left child of the grandparent
                ...
                if uncle.red:
                    ...
                    if new_node == parent.right:
                        # If the new node is a right child, perform a left rotation
                        new_node = parent
